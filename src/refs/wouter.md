<!-- https://github.com/molefrog/wouter/blob/7d6662d3f04920e45d69ec449da1eee22fc6d278/README.md -->
<style>
  body {
...
<a href="https://npmjs.org/package/wouter"><img alt="npm" src="https://img.shields.io/npm/v/wouter.svg" /></a>
<a href="https://codecov.io/gh/molefrog/wouter"><img alt="Coverage" src="https://img.shields.io/codecov/c/github/molefrog/wouter.svg" /></a>
...
function useHashLocation() {
  ...
  return [location, hashNavigate] as const;
}
...
import type { PatternToRegexpResult } from "wouter";
 ...
 *
 * @param path — a path like "/:foo/:bar"
 */
function convertPathToRegexp(path: string): PatternToRegexpResult {
  const keys: PatternToRegexpResult["keys"] = [];
...
```tsx
function NestedRoutes(props: { base: string }) {
  const router = useRouter();
 ...
 */
function multipathMatcher(patterns: string, path: string): Match {
