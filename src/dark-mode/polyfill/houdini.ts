...
abstract class CSSNumericValue {
  ...
  max(...args: any[]): CSSMathMax | CSSUnitValue | null {
  ...
  min(...args: any[]): CSSUnitValue | CSSMathMin | null {
    const result = new CSSUnitValue(this.value, this.unit);
    const values = [result];
...
function parseAsValue(string: string) {
...
abstract class StylePropertyMap {
  ...
  has(key: keyof CSSStyleDeclaration) {
...
function defaults(target: Record<string, any>, source: Record<string, any>) {
...
export function polyfill(window: Window) {
  ...
  defineProperty<CSSRule>(global.CSSRule, "styleMap", (context: any) => context.style);
  defineProperty<Element>(
    global.Element,
    "attributeStyleMap",
    (context: any) => context.style
  );
  defineProperty<Element>(global.Element, "computedStyleMap", context =>
  ...
  function defineProperty<T = any>(
    ...
    if (!(property in Class.prototype)) {
      Object.defineProperty(Class.prototype, property, {
        ...
        get(this: T) {
          const computedStyleMap: StylePropertyMap = Object.create(
